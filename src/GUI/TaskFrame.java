...
/**
 * Třída představující okno pro tvorbu a editaci úkolu
 *
 * @author Adam Žák
 */
public class TaskFrame extends javax.swing.JFrame {
    ...
    /**
     * Konstruktor pro tvorbu nového úkolu
     *
     * @param tasksPaneModel
     */
    ...
    /**
     * Konstruktor pro editaci již existujícího úkolu
     *
     * @param tasksPaneModel
     * @param task
     */
    public TaskFrame(TasksPaneModel tasksPaneModel, Task task) {
        ...
        repaintStudentsComboBox();
        repaintSubjectsComboBox();
        setTitle("Upravit úkol");
        newTask = false;
    }

    /**
     * Privátní metoda sloužící pro vykreslení ComboBoxu se studenty
     */
    private void repaintStudentsComboBox() {
    ...
    /**
     * Privátní metoda sloužící pro vykreslení ComboBoxu s předměty
     */
    private void repaintSubjectsComboBox() {
    ...
    /**
     * Privátní metoda vracející odkaz na model se studenty
     */
    ...
    /**
     * Privátní metoda vracející odkaz na model s předměty
     */
